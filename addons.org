...
determine which browser function to use."
  ...
  (defun mu4e-views--extract-text-and-html-coding-from-gnus (parts)
	...
	(let* ((type (mm-handle-type part))
	  ...
	  ((and (listp part) (equal (mm-handle-media-supertype part) "multipart"))
	   (mu4e-views--extract-text-and-html-coding-from-gnus part))
    ...
    (with-eval-after-load 'notmuch-update
      (setq notmuch-update-command "/opt/local/bin/fdm fetch && notmuch new")
