...
(use-package mu4e
  ...
  (add-to-list 'mu4e-view-actions
               '("View In Browser" . (lambda(msg &optional skip-headers) (poly-view-html-in-browser) )) t)
...
;; (defun mu4e-get-filename ()
;;   "Get the file path of the current email in mu4e."
;;   (interactive)
;;   (mu4e-message-field (mu4e-message-at-point) :path))
#+end_src
