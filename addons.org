...
(use-package notmuch-notify
  ...
  (notmuch-notify-refresh-interval 60)
...
;;  '(notmuch-update :local-repo "/Users/jiya/.emacs.d/site-lisp/notmuch-update/" :type nil))
...
;;   :straight (notmuch-update :local-repo "/Users/jiya/.emacs.d/site-lisp/notmuch-update/" :type nil)
;;   :after (notmuch notmuch-notify)
;;   :custom
;;   (notmuch-update-command "/usr/local/bin/fdm fetch && notmuch new")
...
;;   :bind (:map notmuch-common-keymap (("u" . notmuch-update))))
#+end_src
...
(use-package ebdb
  ...
  (defun poly/org-msg-post ()
    ;; (message "enable ebdb-insinuate-message")
