...
(use-package cape
  ...
  ;; fix (void-function cape-capf-buster)
...
(use-package tabnine
  ...
  ;; (tabnine-log-file-path "/tmp/tabnine-emacs.log")
...
(use-package magit-cz
  :vc (:url "https://github.com/yqrashawn/magit-cz" :rev :newest)
  :after magit)
#+end_src
...
(use-package mu4e
  :vc (:url "https://github.com/djcb/mu" lisp-dir "mu4e/" :branch "release/1.6")
  :commands mu4e
  :defer nil
  :custom
...
(use-package notmuch-notify
  :ensure t
  :disabled
  :vc (:url "https://github.com/firmart/notmuch-notify")
...
(use-package notmuch-update
  :vc (:url "https://github.com/shuxiao9058/notmuch-update" :rev :newest )
  :disabled
  :custom
...
(use-package pdf-continuous-scroll-mode
  :defer t
  :vc (:url "https://github.com/dalanicolai/pdf-continuous-scroll-mode.el"
	    )
  :after pdf-tools
  :config
...
(use-package org-devonthink
  :vc (:url "https://github.com/lasvice/org-devonthink" :rev :newest))
#+end_src
...
(use-package emacs-gc-stats
  :vc (emacs-gc-stats :url "https://git.sr.ht/~yantar92/emacs-gc-stats")
  :config
...
(use-package replace-regexp-list
  :vc (:url "https://github.com/emacsattic/replace-regexp-list"))

(use-package text-to-html
  :vc (:url "https://github.com/emacsattic/text-to-html"))
#+end_src
...
(use-package kdl-mode
  :vc (:url "https://github.com/bobuk/kdl-mode")
  :mode (("\\.kdl\\'" . kdl-mode)))
#+end_src
...
(use-package buffer-name-relative
  :vc (buffer-name-relative :url "https://codeberg.org/ideasman42/emacs-buffer-name-relative")
