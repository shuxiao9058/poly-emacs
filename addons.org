...
(use-package notmuch-notify
  ...
  (notmuch-notify-alert-profiles
   `((:name "inbox"
	    ...
	    :severity urgent
	    :title "Notmuch inbox:"
	    ,(expand-file-name "straight/build/notmuch-notify/notmuch-logo.png" straight-base-dir)
	    :audio ,(expand-file-name "straightbuild/notmuch-notify/emailreceived.wav" straight-base-dir))
     (:name "default")))
  :config
