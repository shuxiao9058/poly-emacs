...
(use-package magit
  ...
  (defun my/magit-status-around (orig-fn &rest args)
    ...
    (apply orig-fn args)
    (delete-other-windows))
  (advice-add #'magit-status :around 'my/magit-status-around ;; (around magit-fullscreen activate)
    ;; (window-configuration-to-register :magit-fullscreen)
    ;; ad-do-it
    ;; (delete-other-windows)
	      )
  ...
  (defun my/magit-quit-window-after (orig-fn &rest args)
    ...
    (apply orig-fn args))
    (advice-add #'magit-quit-window :after
		'my/magit-quit-window-after)
...
determine which browser function to use."
  ...
  (defun new-html-buffer(txt)
    (with-temp-buffer
      ...
      (insert (base64-encode-string (encode-coding-string
				     (text-to-html-string (text-newline-to-br txt))
				     'utf-8)))
      (buffer-string)))
