...
|-------------+-------------------+-----------------------------------|
| default     | Roboto Mono       | default font for ascii characters |
| cjk         | Sarasa Mono SC    | default font for cjk characters   |
| symbol      | Sarasa Mono SC    | default font for unicode symbols  |
| fixed       | Source Code Pro   | for face ~fixed-pitch~              |
| fixed-serif | Sarasa Mono SC | for face ~fixed-pitch-serif~        |
| variable    | Source Serif Pro  | for face ~variable-pitch~           |
