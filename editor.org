...
(use-package org-agenda
  ...
  (setq org-agenda-custom-commands `(
				...
				("wrw" "Week in review" agenda "Week Review"
				 ;; agenda settings
				 ,(append
				   poly/work-org-agenda-review-settings
				   '((org-agenda-span 'week)
				...
				("wd" "Work Agenda for the day" agenda "Work Agenda"
				 ((org-agenda-span 'day)
				  (org-agenda-files poly/work-org-agenda-files;; '(,+org-capture-work-gtd-file
						    ;;   ,+org-capture-work-team-gtd-file
						    ;;   ,+org-capture-work-meeting-file)
						    )
				  (org-agenda-skip-function '(org-agenda-skip-deadline-if-not-today))))))
