...
(use-package emacs
  ...
  :init
  (setq trusted-content '("~/workspace"))
...
(use-package mule
  ...
  (add-to-list 'process-coding-system-alist '("clj-kondo" . (utf-8 . utf-8)))
  ;; Treat clipboard input as UTF-8 string first; compound text next, etc.
...
;;   :defer t
;;   :vc (consult-project-extra :url "https://github.com/Qkessler/consult-project-extra" :branch "main" :rev :newest)
...
;; (add-hook 'emacs-startup-hook (lambda() (call-interactively #'toggle-frame-maximized)))
...
Stop electric from indent things automatically. Highlight matching pairs of characters.
...
(use-package electric
  ...
  ;; (electric-indent-inhibit nil)  ; Auto-indent code after e.g. {}
  :config
  (electric-indent-mode nil)) ;; disable auto-identation
...
(use-package elec-pair
  ...
  ((clojure-mode . electric-pair-mode)
   ...
   ((c-mode c++-mode objc-mode swift-mode) . electric-pair-mode)
...
(use-package highlight-indent-guides
  :vc (:url "https://github.com/DarthFennec/highlight-indent-guides"
	    :branch "master" :rev :newest
	    :ignored-files ("tests/highlight-indent-guides-tests.el" "tests/highlight-indent-guides-known-bugs-tests.el"))
...
(use-package highlight-parentheses
  :vc (:url "https://git.sr.ht/~tsdh/highlight-parentheses.el" :branch "main" :rev :newest)
...
#+begin_src emacs-lisp :tangle no
(use-package jupyter
  :vc (emacs-jupyter :url "https://github.com/nnicandro/emacs-jupyter" :rev :newest :branch "master")
  :custom
...
(use-package zmq
  :vc (:url "https://github.com/dzop/emacs-zmq" :branch "master" :rev :newest)
  ;; :disabled
  :init
...
(use-package org
  ...
  (setq +org-capture-work-project-file (expand-file-name "work-project.org" org-beorg-directory))
...
do not already have one."
  ...
  (setq org-capture-templates
	'(;; ("t" "Personal todo" entry
	  ...
	  ;;  "* TODO %?\n%i%U\n" :kill-buffer nil)
	  ("t" "Personal todo" entry
	   (file+olp +org-capture-gtd-file "P-GTD")
	   "* TODO %?\n%i%U\n" :kill-buffer nil)
	  ...
	  ("wn" "Work notes" entry
	   ...
	   "* %u %?\n%i\n%a" :kill-buffer nil)
	  ("wp" "Work project notes" entry
	   (file+olp +org-capture-work-project-file  "W-Project")
	   "* %u %?\n%i\n%a" :kill-buffer nil)
	  ...
	  ("pt" "Project todo" entry ; {project-root}/todo.org
	   (file+headline +org-capture-work-project-file "PRJ-GTD ")
	   "* TODO %T%?\n%i\n%a" :prepend nil :kill-buffer t)
	  ("pn" "Project notes" entry ; {project-root}/notes.org
	   (file+headline +org-capture-work-project-file "PRJ-Note")
	   "* TODO %?\n%i%U\n%a" :prepend nil :kill-buffer t)
	  ("pc" "Project changelog" entry ; {project-root}/changelog.org
	   (file+headline +org-capture-work-project-file "PRJ-Changelog")
	   "* TODO %?\n%i%U\n%a" :prepend nil :kill-buffer t)
	  ("j" "Journal" entry
...
(defun poly/org-insert-sub-task ()
  (interactive)
...
(use-package appt
  ...
  (defun appt-display-with-notification(min-to-app new-time appt-msg)
    (terminal-notify (format "Appointment in %s minutes" min-to-app)
		     (format "%s" appt-msg))
    (appt-disp-window min-to-app new-time appt-msg))
  (appt-activate 1)
  (org-agenda-to-appt)
...
instead with =org-superstar-mode=

#+begin_src emacs-lisp
;; Pretty stars for org-mode
(use-package org-superstar-mode
  :vc (:url "https://github.com/integral-dw/org-superstar-mode" :branch "master" :rev :newest)
...
(use-package org-clock-budget
  :vc (:url "https://github.com/Fuco1/org-clock-budget" :branch "master" :rev :newest)
...
(use-package org-roam-ui
  :vc (:url "https://github.com/org-roam/org-roam-ui" :branch "main" :rev :newest)
  :after org-roam
  :custom
...
(use-package notdeft
  ...
  :vc (:url "https://github.com/hasu/notdeft" :branch "master" :rev :newest)
  :config
...
(use-package plantuml-mode
  :vc (:url "https://github.com/shuxiao9058/plantuml-mode" :branch "develop" :rev :newest)
  :config
...
(use-package tributary
  :vc (:url "https://github.com/mrkrd/tributary" :branch "master" :rev :newest)
  :custom
...
#+begin_src emacs-lisp :tangle no
(use-package uniline
  :vc (:url "https://github.com/tbanel/uniline" :branch "main" :rev :newest)
