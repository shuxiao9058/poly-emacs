...
(use-package lsp-mode
  ...
  (setq lsp-enabled-clients '(lua-language-server
			      ...
			      html-ls emmet-ls nginx-ls bash-ls unified sqls yamlls xmlls taplo))
  ...
  (lsp-register-custom-settings
   `(("gopls.usePlaceholders" t t)
     ...
     ("Lua.format.defaultConfig.quote_style" "single")
...
(dolist (hook '(go-ts-mode-hook lua-mode-hook
