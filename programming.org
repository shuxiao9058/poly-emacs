...
:vc (:url "https://github.com/flycheck/flycheck-color-mode-line")
...
Examples:
  ...
  (+eglot-register '(go-mode  go-dot-mod-mode go-dot-work-mode go-ts-mode go-mod-ts-mode) `("gopls" "-debug" "127.0.0.1:3000" "-logfile=/tmp/gopls-emacs.log" ;; "-rpc.trace" "-vv"
   											    ))
...
:vc (:url "https://github.com/shuxiao9058/lsp-protobuf"
       )
  :custom
...
(use-package cape-yasnippet
  ...
  :vc (:url "https://github.com/elken/cape-yasnippet")
  :ini
...
(use-package cpp-auto-include
  :vc (:url "https://github.com/emacsorphanage/cpp-auto-include"
	    :rev :newest
	    :branch "master")
