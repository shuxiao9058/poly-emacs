...
(use-package apheleia
  ...
  ;; (add-to-list 'apheleia-formatters '(google-java-format2 . ("java" "-jar" "/usr/local/bin/google-java-format-1.17.0-all-deps.jar" "-")))
...
(use-package eglot
  ...
  (eglot-stay-out-of '(imenu eldoc))  ;; eglot reinits backends
...
(with-eval-after-load 'lsp-pylsp
  ...
  (lsp-register-custom-settings
   `(("gopls.usePlaceholders" t t)
     ...
     ("gopls.formatting.gofumpt" ,(if (executable-find "gofumpt") t nil) t)
