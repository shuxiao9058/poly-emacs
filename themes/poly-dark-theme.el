...
(let ((colors '(
      ...
      (faces '( ;; default
	        ...
	        ,@(if poly-dark-alternate-mode-line-and-minibuffer
               ...
               (mu4e-related-face                              :inherit default :slant italic)
	       ...
	       (mu4e-compose-separator-face                  :inherit message-separator :slant italic)
	       ...
	       (fill-column-indicator          :foreground ,current :height 0.85)
		...
		,@(if poly-dark-alternate-mode-line-and-minibuffer
	       ...
	       (font-lock-function-name-face :foreground ,green :weight bold)
               ...
               (font-lock-property-name-face :foreground ,cyan)
		...
		,@(if poly-dark-alternate-mode-line-and-minibuffer
	      ...
	      (eat-term-color-12                         :foreground ,bright-blue)
	       ...
	       (eshell-ls-directory :foreground ,alt-blue :weight bold)
